...
---
## 🖥️ Использование соединений (JOIN), подзапросов и функций преобразования данных
## 🔍 Цель работы
...
| 💾 **SQL-запросы** | Все запросы в одном файле с пояснениями | [`lab_02/sql/lab_02.sql`](https://github.com/Margarita-Eskova/practicum-sql/blob/main/lab_02/sql/lab_02.sql) |
