...
Первые два задания из первой и второй части лабораторной были выполнены в базе данных преподавателя (`bi_sql_data_student`).  
Третьи задания из первой и второй части лабораторной были выполнены на моей локальной базе данных (`mylocaldb`).

---

## Подготовка базы данных преподавателя в DBeaver

### 1. Подключение к базе преподавателя

В DBeaver было создано новое подключение к PostgreSQL с параметрами, выданными преподавателем:

- **Host:** [IP-адрес или домен преподавателя]
- **Port:** 5432
- **Database:** `bi_sql_data_student`
- **Username:** [логин от преподавателя]
- **Password:** [пароль от преподавателя]

**Скриншот:** *вставьте изображение настроек подключения*

### 2. Проверка подключения

После сохранения подключения была выполнена проверка через **Test Connection** – получен статус **Connected**.

**Скриншот:** *вставьте изображение успешного теста подключения*
...
**Скриншот:** *вставьте изображение списка таблиц*
