...
Результатом выполнения команды стало добавление базы данных mylocaldb в DBeaver на виртуальной машине, в которую я теперь спокойно могу скопировать любую таблицу из базы данных преподавателя
...
| 💾 **SQL-запросы** | 1 и 2 части sql-запросов в одной папке | [`lab_01/sql/lab_01.sql`](https://github.com/Margarita-Eskova/practicum-sql/blob/main/lab_01/sql/lab_01.sql) |
